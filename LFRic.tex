...
\begin{lstlisting}[language=Fortran]
 nlayers = v_proxy%vspace%get_nlayers()
      ...
      DO cell=1,mesh%get_last_halo_cell(1)
        !
        CALL matrix_vector_code(cell, nlayers, v_proxy%data, s_proxy%data, mm_proxy%ncell_3d, mm_proxy%local_stencil, ndf_any_space_1_v, undf_any_space_1_v, map_any_space_1_v(:,cell), ndf_any_space_2_s, undf_any_space_2_s, map_any_space_2_s(:,cell))
      END DO 
      !
      ! Set halos dirty/clean for fields modified in the above loop
      !
