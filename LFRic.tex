...
\texcolor{red}{(Comment: vertical-only velocity space is mentioned in Section~\ref{sec:sub:preconditioner}
...
\textcolor{red}{\em (Comment: Explain/give reference to what is Picard iteration?)}
Future work is evaluating the use of flux-form Semi-Lagrangian scheme (COSMIC) ~\cite{Leonard1996} 
...
is used in LFRic. This is a more advanced solver than
