...
and is where the data parallelism is expressed.  

\begin{figure}[]
\centering\includegraphics[width=1.0\linewidth]{PSyKAl.pdf}
\caption{\label{fig:psykal} Schematic diagram of the PSyKAl layered architecture.}
\end{figure}
